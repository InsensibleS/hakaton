...
<body>
    ...
    <main> <!--Левое меню -->
        <div class="container hero-container">
            ...
            <div>
                <div class="title">Дорожная карта  <img src="http://127.0.0.1:8000/img/svg/1.svg"> Проекты <img src="http://127.0.0.1:8000/img/svg/1.svg"> Карточка проекта</div>
            <div class="cp_ work-area _with-kroshka">
                <div class="info">
                    <div class="info-left">
                        <div class="direction">Направление</div>
                        <div class="sta _gray">Умный городской транспорт</div>
                    </div>
                    <div class="info-right">
                        <div>Дата: {{$date}}</div>
                        <div>Время: {{$time}}</div>
                        <div>Адрес: г. Новороссийск, ул. Калатушкина 01</div>
                    </div>
                </div>
                <p style="padding-left: 30px">{{$project->title}}</p>
                <div class="content">
                    <div class="left-column">
                        <div class="responsible">
                            <div>Ответственный</div>
                            <div class="_gray">{{$project->company->title}}</div>
                        </div>
                        <div class="status-box">
                            <div>Статус</div>
                            <div class="status">
                                <img src="/img/svg/yel-circle.svg" alt="">
                                <div>@if($project->status == 'executed')
                                        К выполнению
                                    @endif
                        ...
                        <div class="photo-video">
                            <div class="photo">
                                <a href=""><img src="/img/svg/photo.svg" alt=""></a>
                            </div>
                            <div class="video">
                                <a href=""><img src="/img/svg/video.svg" alt=""></a>
                            </div>
                        </div>
                        <div class="tasks-projects">
                            <a href="/popup">Задачи по проекту</a>
                        </div>
                    </div>
                    <div class="line-horz-short"></div>
                    <div class="right-column">
                        <img src="/img/png/chat-scrin.png" alt="">
                    </div>
                </div>
            </div>
        </div>
