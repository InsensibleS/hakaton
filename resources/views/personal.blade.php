...
<main> <!--Левое меню -->
    <div class="container hero-container">
        <ul class="hero-list">
            ...
            <li class="hero-item__personal  _active-sos">
                <a class="personal-btn btn  _active-btn" href="/personal"><img src="/img/svg/personal.svg" class="personal-img hero-img" alt="">СОТРУДНИКИ</a>
            </li>
        ...
        <div class="work-area" style="background-color: rgba(255, 255, 255, 0.64);">
            <img src="/img/png/12.png" width="100%">
        </div>
    </div>
