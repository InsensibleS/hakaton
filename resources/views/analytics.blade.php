...
<main> <!--Левое меню -->
    <div class="container hero-container">
        <ul class="hero-list">
            ...
            <li class="hero-item__analytics analytics-mar  _active-sos">
                <a class="analytics-btn btn  _active-btn" href="/analytics"><img src="/img/svg/analytics.svg" class="analytics-img hero-img" alt="">АНАЛИТИКА/ОТЧЁТЫ</a>
            </li>
        ...
        <div class="work-area" style="background-color: #FFFACE">
            <img src="/img/png/14.png" width="100%">
        </div>
    </div>
