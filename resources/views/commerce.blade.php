...
<main> <!--Левое меню -->
    <div class="container hero-container">
        <ul class="hero-list">
            ...
            <li class="hero-item__commerce _active-sos">
                <a class="commerce-btn btn _active-btn"  href="/commerce"><img src="/img/svg/commerce.svg" class="commerce-img hero-img" alt="">КОММЕРЧЕСКИЕ<br>ПРЕДЛОЖЕНИЯ</a>
            </li>
        ...
        <div class="work-area" style="background-color: #FFFACE">
            <img src="/img/png/13.png" width="100%">
        </div>
    </div>
