...
<main> <!--Левое меню -->
    <div class="container hero-container">
        <ul class="hero-list">
            ...
            <li class="hero-item__iq _active-sos">
                <a class="iq-btn btn _active-btn" href="/iq"><img src="/img/svg/iq.svg" class="iq-img hero-img" alt="">KPI-ПОКАЗАТЕЛИ IQ</a>
            </li>
        ...
        <div class="work-area">
            <img src="/img/png/10.png" width="100%">
        </div>
    </div>
