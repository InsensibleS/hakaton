    ...
    <header class="header"> <!--Хедер-->
        <div class="container header-container">
            <ul class="header-list">
                ...
                <li class="header-item">
                    <a href="https://script.google.com/macros/s/AKfycbxTNyJLJkQjxqefFvopYCxI6QdPpG8dmd0IYcLpva8EPn_9as4TbZYMNMgdtphSmzch/exec" class="user-btn">
...
{{--            <div class="header-form">--}}
    ...
    <main> <!--Левое меню -->
        <div class="container hero-container">
            <ul class="hero-list">
                <li class="hero-item__maps _active-sos">
                    <a class="maps-btn btn _active-btn" href="/maps"><img src="/img/svg/maps.svg" class="maps-img hero-img" alt="">ДОРОЖНАЯ КАРТА(ДК)</a>
                </li>
            ...
            <div class="work-area">
                <div style="display: flex">
                    <div style="width: 80%">
                    <form method="POST" action="/maps/create" enctype="multipart/form-data">
                        @csrf
                        <div class="text-field">
                            <label class="text-field__label" for="login">Название проекта</label>
                            <input class="text-field__input" type="text" name="title" id="login" placeholder="Название проекта">
                        </div>
                        <div class="text-field">
                            <label class="text-field__label" for="date">Дата / Время</label>
                            <input class="text-field__input" type="datetime-local" name="date" placeholder="Дата / Время">
                        </div>
                        <div class="text-field">
                            <label class="text-field__label" for="company">Ответственный</label>
                            <select class="text-field__input" name="company">
                                @if($company->count() != 0)
                            ...
                            <label class="text-field__label" for="status">Статус</label>
                            <select class="text-field__input" name="status">
                                <option value="overdue">Просрочено</option>
                                <option value="done">Выполнено</option>
                                <option value="progress">Выполняется</option>
                                <option value="executed"> К выполнению</option>
                            </select>
                        ...
                        <div class="text-field">
                            <label class="text-field__label" for="files"></label>
                            <input class="text-field__input" type="submit" value="Создать" style="background-color: #7ED3A7">
                        </div>
                    </form>
                    </div>
                    <div>
