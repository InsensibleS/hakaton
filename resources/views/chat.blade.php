...
<main> <!--Левое меню -->
    <div class="container hero-container">
        <ul class="hero-list">
            ...
            <li class="hero-item__chat  _active-sos">
                <a class="chat-btn btn  _active-btn" href="/chat"><img src="/img/svg/chat.svg" class="chat-img hero-img" alt="">ЧАТ</a>
            </li>
        ...
        <div class="work-area" style="background-color: #FFFACE">
            <img src="/img/png/11.png" width="100%">
        </div>
    </div>
