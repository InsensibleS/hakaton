...
<main> <!--Левое меню -->
    <div class="container hero-container">
        <ul class="hero-list">
            ...
            <li class="hero-item__settings _settings-mar  _active-sos">
                <a class="settings-btn btn _active-btn" href="/settings"><img src="/img/svg/settings.svg" class="settings-img hero-img" alt="">НАСТРОЙКИ</a>
            </li>
        </ul>
